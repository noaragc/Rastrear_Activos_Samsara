...
async def main():
    ...
    #[print(v) for x,v in vehicles_location.items()]
...
def send_email(context):
    ...
    <head> 
        ...
        <body>        
            ...
            <p>Tiempo y Hora UTC: {context[3]}</p>  
        ...
        print('Email Enviado - Tractor: '+context[1])
